...
<head>
    ...
    <title>Confirmation of Your Gig Acceptance</title>
    <style type="text/css">
        a {
                                                            ...
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    ...
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        Congratulations! You have successfully accepted the gig for "{{ $gig->gig->title }}". Here are the details of your upcoming engagement: <br><br>
                                                                        <ul>
        <li><strong>Client Name:</strong> {{ $client->last_name .' '. $client->first_name }}</li>
        <li><strong>Location:</strong> {{ $client->address1 . (!empty($client->address2) ? ', ' . $client->address2 : '') }}</li>
        <li><strong>Contact:</strong> {{ $client->phone_number }}</li>
    </ul>
                                                                        <br><br>

                                                                        Please make sure to reach out to the client at least a few days before the event to confirm any final arrangements and details. Attached are the event specifics and any additional documents provided by the client for your reference. <br><br>

                                                                        We are thrilled to have you onboard and hope this event is a huge success. If you have any questions or need further assistance, please do not hesitate to contact us at <a href="mailto:support@stghcs.com">support@stghcs.com</a> or call us directly at <a href="tel:+1(917)8644771">+1(917)8644771</a>. <br><br>

                                                                        Thank you for using St. Genevive Health Care Services to connect with your gigs. We wish you the best for this upcoming event!
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tr>
                                                                <td align="left" style="padding:0;Margin:0">
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">Best Regards,<br><br>St. Genevive Health Care Services</p>
                                                                </td>
                                                            </tr>
                                                            <tr>

...
<head>
    ...
    <title>Confirmation of Gig Acceptance</title>
    <style type="text/css">
        a {
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#fafafa;border-radius:10px" role="presentation">
                                                            <tr>
                                                                <td align="left" style="padding:20px;Margin:0">
                                                                    <h3 style="Margin:0;line-height:34px;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;font-size:28px;font-style:normal;font-weight:bold;color:#2D3142">Hello,&nbsp;{{ $client->last_name }} {{ $client->first_name }}</h3>
                                                                    ...
                                                                    <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:Imprima, Arial, sans-serif;line-height:27px;color:#2D3142;font-size:18px">
                                                                        We are pleased to inform you that {{ $user->last_name .' '. $user->first_name }} has accepted the gig for your event, {{ $gig->title }}. Here are the details:<br><br>
                                                                        <ul>
        <li><strong>Performer/Service Provider:</strong> {{ $user->last_name .' '.$user->first_name }}</li>
        <li><strong>Contact:</strong> {{ $user->phone_number }}</li>
    </ul>
                                                                        <br><br>

                                                                        {{ $user->last_name .' '.$user->first_name }} will be contacting you shortly to discuss the event specifics and any requirements you might have discussed. We have attached their profile and past performance reviews for your reference. <br><br>

                                                                        Should you need to communicate further details or have any questions, please feel free to reach out directly to <a href="mailto:support@stghcs.com">support@stghcs.com</a> or call us directly at <a href="tel:+1(917)8644771">+1(917)8644771</a> <br><br>

                                                                        Thank you for choosing St. Genevive Health Care Services for your event needs. We are committed to ensuring your event is a memorable one and look forward to supporting you in any way we can.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
